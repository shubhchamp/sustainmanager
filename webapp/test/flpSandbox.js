		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#cprailsurveycprailmanager-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cprailsurveycprailmanager-display": {
								"semanticObject": "cprailsurveycprailmanager",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cprail.survey.cprailmanager",
									"url": sap.ui.require.toUrl("cprail/survey/cprailmanager")
								}
							}
						}
					}
